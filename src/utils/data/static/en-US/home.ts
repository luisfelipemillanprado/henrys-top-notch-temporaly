 ...
 * @property {string} bookingProcess.steps.icon - The name of the icon representing a specific step in the booking process section.
...
export const homeData = {
  ...
  bookingProcess: {
    ...
    image: '/images/home/booking-process/booking-process.webp',
    features: [
      {
        icon: 'emergency',
