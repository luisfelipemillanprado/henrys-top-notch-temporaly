import type { NetworkProps } from '@/common/footer/types'
 ...
 * @component
 * @param {NetworkProps} props - Component properties with href, icon, name and id.
 ...
 * @param {string} props.name - The name value for the social network (reserved for a11y/labels).
 * @param {number} props.id - Stable key for list rendering.
 * @returns A rendered social network component.
 */
export const Network = ({ href, icon }: NetworkProps) => {
  return (
    <Link
