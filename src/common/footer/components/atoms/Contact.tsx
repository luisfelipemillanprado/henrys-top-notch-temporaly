import type { ContactProps } from '@/common/footer/types'
 ...
 * @component
 * @param {ContactProps} props - Component properties with text, href, type, icon and id.
 ...
 */
export const ContactInformation = ({ text, href, type, icon }: ContactProps) => {
  const content = (
    <>
