import type { HighlightProps } from '@/common/highlight/types'
import { ArrowTrendingDownIcon } from '@heroicons/react/24/solid'
import clsx from 'clsx'

/**
 * @description Renders a highlighted block with an arrow icon and two lines of customizable text.
 * @component
 * @param {HighlightProps} props - Component properties.
 ...
 */
export const Highlight = ({ firstText, secondText }: HighlightProps) => {
  return (
    <div
      className={clsx(
        'horizontal',
