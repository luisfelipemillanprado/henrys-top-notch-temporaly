import type { DecorationProps } from '@/common/decoration/types'
import clsx from 'clsx'

/**
 * @description Configuration for the Decoration component, defining positions and sizes for 2 or 4 rings.
 * @private
 * @type {object}
 */
const CONFIG = {
...
/**
 * @description Render ring decoration elements positioned absolutely at the top of the screen.
 * @component
 * @param {DecorationProps} props - Component properties with rings and changeColor optional.
 ...
 * @returns Renders a decoration component containing the absolute-positioned rings.
 */
export const Decoration = ({ rings = 2, changeColor = false }: DecorationProps) => {
