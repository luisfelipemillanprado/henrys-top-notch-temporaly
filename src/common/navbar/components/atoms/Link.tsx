import type { LinkItem } from '@/common/navbar/types'
import {
...
/**
 * @description Renders link component.
 * @component
 * @param {LinkItem} props - Component properties.
 ...
 * @returns Returns link component.
 */
export const NLink = ({ text, href, icon, handleCloseOptions }: LinkItem) => {
  return (
