import { WhoWeAre } from '@/features/home/components/molecules/WhoWeAre'
...
/**
 * @description Renders the who we are section, presenting the company identity
 ...
 */
export const OurWhoWeAre = () => {
  const t = useTranslations('home.our-who-we-are')
  const title = t('title')
