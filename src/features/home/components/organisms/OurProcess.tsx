import { Process } from '@/features/home/components/molecules/Process'
...
/**
 * @description Renders the process section, managing the integration of localized content,
 ...
 * @param {string} props.description - A localized summary of the process.
 * @param {string} props.eyebrow - A short localized label or "eyebrow" text above the main title.
 * @param {string} props.image - The static image URL representing the process section.
 ...
 * @param {object[]} props.steps - Localized list of steps in the process workflow.
 ...
 * @returns Returns a process section with localized overview, features, steps, and CTA.
 */
export const OurProcess = () => {
  const t = useTranslations('home.our-process')
  const title = t('title')
