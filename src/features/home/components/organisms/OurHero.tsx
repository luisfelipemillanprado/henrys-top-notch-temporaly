import { Decoration } from '@/common/decoration/components/Decoration'
...
import { Actions } from '@/features/home/components/molecules/Actions'
import { Gallery } from '@/features/home/components/molecules/Gallery'
...
/**
 * @description Renders the hero section of the homepage with localized content and a media gallery.
 * @component
 ...
 * @returns Returns a hero section with localized copy, dual CTAs, decoration, and media gallery.
 */
export const OurHero = () => {
  const t = useTranslations('home.our-hero')
  const title = t('title')
    ...
    >
      ...
      <div className={clsx('vertical', 'size-full', 'justify-start', 'md:justify-start')}>
        ...
        >
          ...
          <Actions primaryCta={primaryCta} secondaryCta={secondaryCta} highlight={highlight} />
        </div>
      </div>
