import { Contact } from '@/features/home/components/molecules/Contact'
import { layoutAssets } from '@/utils/data/static/global/layout'
import { homeAssets } from '@/utils/data/static/pages/home'
import clsx from 'clsx'
import { useTranslations } from 'next-intl'

const { sectionId, headingId, image, primaryCtaHref } = homeAssets.contact
const { contactForm: contactFormAssets } = layoutAssets

/**
 * @description Renders the "Contact" section, integrating a localized lead visual,
...
export const OurContact = () => {
  const tContact = useTranslations('home.our-contact')
