...
import { Service } from '@/common/service/components/organisms/Service'
import clsx from 'clsx'

/**
 * @description Renders the some-services section content with header CTA and service cards.
 * @component
