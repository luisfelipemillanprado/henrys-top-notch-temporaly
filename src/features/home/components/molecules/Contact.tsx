...
import { ContactForm } from '@/common/contact/email/components/organisms/ContactForm'
...
/**
 * @description Renders the contact section with header content, lead visual, and form.
 * @component
 ...
 * @returns Returns a responsive contact section layout with visual, header, and form.
 */
