...
/**
 * @description Renders the reason component as an accordion item.
 * @component
 ...
 * @returns Returns an accordion with the provided reason entries.
 */
export const Reason = ({
  reasons,
}: {
  ...
  return (
    <Accordion
      hideSeparator={true}
      className={clsx('gap-y-6', 'm1x:gap-y-6.5', 'md:gap-y-7', 'lg:gap-y-8', 'xl:gap-y-8')}
    >
      {reasons.map((item) => (
