...
import { LearnMore } from '@/features/home/components/atoms/LearnMore'
...
export const Feature = ({
  ...
  return (
    ...
    >
      <div className={clsx('vertical', 'w-full', 'items-start', 'gap-y-4.5', 'lg:gap-y-5')}>
      ...
      <LearnMore href={href} text={text} isActive={isActive} />
    </div>
  )
}
